...
histdir="${workspace}../amod_tests/datadistri/alexnet_4097_new_even_hist/"
range_outdir="${workspace}../amod_tests/datadistri/alexnet_4097_new_even_hist/log_range"
data_outdir="${workspace}../amod_tests/datadistri/alexnet_4097_new_even_hist/log_data"
