#ifndef CAFFE_SPLITC_CONV_LAYER_HPP_
#define CAFFE_SPLITC_CONV_LAYER_HPP_
 ...
 *       by split in C direction to reduce SRAM footprint
 */
template <typename Dtype>
class SplitCConvolutionLayer : public BaseConvolutionLayer<Dtype> {
 public:
  /**
   ...
   */
  explicit SplitCConvolutionLayer(const LayerParameter& param)
      : BaseConvolutionLayer<Dtype>(param)
       {
      }

  virtual inline const char* type() const { return "SplitCConvolution"; }
